  ...
  <div class="page-content">
    <div class="row">
      <div class="col-md-12">
        ...
        <h3 class="page-title"> Abstract View Master </h3>
      </div>
    </div>
        ...
        <div class="portlet">
          <div class="portlet-body">
            <div class="table-container"  id="viewBlogDiv">
              <?php 
				$sql= "select * from abstract  order by aId desc";
				$result=query($sql);
	 	      ?>
						...
						<td>'.$resultRow['title'].'</td>
					 	<td>';	
							if($resultRow['status']==1)
							 {
									$list.='<button onclick="showHidePost('.$resultRow["aId"].',0)" type="button" class="btn btn-info">Active</button>';
							 }
							 else
							 {
									$list.='<button onclick="showHidePost('.$resultRow["aId"].',1)" type="button" class="btn btn-danger">Deactivate</button>';
							 }
						...
						$list.='</td>
					 	<td>';	
							if($resultRow['isPopular']==1)
							 {
									$list.='<img title="Popular" src="assets/images/active.png" onclick="isPopular('.$resultRow["aId"].',0)" type="button"> ';
							 }
							 else
							 {
									$list.='<img title="Not Popular" src="assets/images/deactive.png" onclick="isPopular('.$resultRow["aId"].',1)" type="button"> ';
							 }
							
						$list.='</td>
					 	<td> 
						<button type="button" onclick="updatePost('.$resultRow['aId'].')" class="btn green-meadow">View/Edit</button>
						</td>
						<td>
						<button type="button" onclick="deletePost('.$resultRow['aId'].')" class="btn btn-warning">Delete</button> </td>
                  	</tr>';
		}
		if($i==1)
		{
		 ...
		 ?>
            ...
            <div id="addNewBlogDiv" style="display:none">
              <form action="#" method="post" onSubmit="return checkValidation();" name="PostForm" id="PostForm" enctype="multipart/form-data">
                <input type="hidden" name="action" value="addAbstract">
                <table  class="table-form">
                  <tr>
                    <th width="20%">Select Cetogory</th>
                    <td width="70%"> <select name="menucategory"id="position" class="form-control requiredInput">
                  ...
                  <tr>
				   ...
				   <tr>
                    ...
                    <td width="70%"><input type="text" name="author" id="Author" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
				  
				   <tr>
                    <th width="20%">DOI</th>
                    <td width="70%"><input type="text" name="doi" id="title" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                  <tr>
                    <th>File</th>
                  ...
                  <tr>
                    <th>ABSTRACT</th>
                    <td><textarea class="form-control" name="abstract" id="sdescription" > </textarea></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td></td>
                    <td><input type="submit" name="add_banner" value="Submit Abstract" class="btn green" ></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                </table>
              </form>
