              ...
              <form action="" method="post" onSubmit="return checkValidation();" name="servicesForm" id="servicesForm" enctype="multipart/form-data">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td width="70%"><input type="text" name="mPrice" id="image" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                   <tr>
                    <th width="20%"> Description</th>
					<td  width="70%"><textarea class="form-control requiredInput" name="desc" id="description" > </textarea></td>
                   ...
                   <tr>
                    ...
                    <td width="70%"><label class="control-label">Note: <span style="color:#FF0000;"> (Abstract File Size not more then 10MB)</span></label>
                    	<input type="file" name="sImage" id="image" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td></td>
