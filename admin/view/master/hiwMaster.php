              ...
              <form action="" method="post" onSubmit="return checkValidation();" name="hiwForm" id="hiwForm" enctype="multipart/form-data">
                ...
                <table  class="table-form">
				  ...
				  <tr>
                    ...
                    <td width="70%"><input type="text" name="facebook" id="name" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
				  <tr>
                    <th width="20%">Instagram</th>
                    <td width="70%"><input type="text" name="instagram" id="name" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
				  <tr>
                    <th width="20%">Twitter</th>
                    <td width="70%"><input type="text" name="twitter" id="name" class="form-control requiredInput"></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                  <tr>
                    <td></td>
                    <td><input type="submit" name="add_banner" value="Add Team Member" class="btn green" ></td>
                    <td width="5%">&nbsp;</td>
                  </tr>
                </table>
              </form>
...
function deleteTeam(Id)
{
	...
	var temp=confirm("Are You Confirm to delete this Team!");
	if(temp)
	{
	$.ajax({
