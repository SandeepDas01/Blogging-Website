...
<!-- BEGIN LOGO -->
<div class="page-logo"> <a href="?action=home"> <img   src="assets/images/logo.png" alt="fitness" style="padding-top: 2%;width: 100%;" class="logo-default" /> </a>
    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
      ...
      <a href="javascript:void(0);" class="nav-link nav-toggle"> <i class="fa fa-user"></i> <span class="title">CMS</span> <span class="arrow "></span> </a>
        <ul class="sub-menu">
         ...
         <li <?php if(isset($_REQUEST['action']) && ($_REQUEST['action']=="menucetegory")){ echo "class='active'";} ?>> <a href="?action=menucetegory"> <i class="fa fa-folder-open"></i>Menu Cetegory Master</a> </li>

          <li <?php  if( isset($_REQUEST['action']) && ($_REQUEST['action']=="serviceNameMaster" || $_REQUEST['action']=="addNewServices")){ echo "class='active'";} ?>> <a href="?action=serviceNameMaster"> <i class="fa fa-folder-open"></i>Menu</a> </li>
          ...
          <li <?php if( isset($_REQUEST['action']) && ($_REQUEST['action']=="testimonialsMaster" || $_REQUEST['action']=="addtestimonialsMaster")){ echo "class='active'";} ?>> <a href="?action=testimonialsMaster"> <i class="fa fa-folder-open"></i>Testimonials</a> </li>
      ...
      <li class="nav-item <?php if( isset($_REQUEST['action']) && ($_REQUEST['action']=="blogMaster" || $_REQUEST['action']=="commentsMaster" || $_REQUEST['action']=="addNewPost"  || $_REQUEST['action']=="addNewBlogCategory" )){ echo " active";} ?>" > <a href="javascript:void(0);" class="nav-link nav-toggle"> <i class="fa fa-user"></i> <span class="title">Blog Master</span> <span class="arrow "></span> </a>
        <ul class="sub-menu">
          <li class="nav-item <?php if(isset($_REQUEST['action']) && ($_REQUEST['action']=="blogMaster")){ echo " active";} ?> "> <a href="?action=abstractviewmaster"> <i class="fa fa-folder-open"></i>Post Master</a> </li>
     ...
     <li class="nav-item <?php   if( isset($_REQUEST['action']) && ($_REQUEST['action']=="galleryMaster"  || $_REQUEST['action']=="addNewGallery" || $_REQUEST['action']=="updateGalleryImage"  || $_REQUEST['action']=="video"  )){ echo " active ";} ?> " > <a href="javascript:void(0);" class="nav-link nav-toggle"> <i class="fa fa-user"></i> <span class="title">Gallery</span> <span class="arrow "></span> </a>
	  ...
	  <li class="nav-item <?php if( isset($_REQUEST['action']) && ($_REQUEST['action']=="contactQuery" || $_REQUEST['action']=="aptQuery" )){ echo "  active";} ?>" > <a href="javascript:void(0);" class="nav-link nav-toggle"> <i class="fa fa-user"></i> <span class="title">Queries</span> <span class="arrow "></span> </a>
	   ...
	   <li class="nav-item <?php if( isset($_REQUEST['action']) && ($_REQUEST['action']=="contactQuery" || $_REQUEST['action']=="aptQuery" )){ echo "  active";} ?>" > <a href="javascript:void(0);" class="nav-link nav-toggle"> <i class="fa fa-user"></i> <span class="title">View Article</span> <span class="arrow "></span> </a>
        <ul class="sub-menu">
          <li <?php if(isset($_REQUEST['action']) && ($_REQUEST['action']=="trainerMaster")){ echo "class='active'";} ?>> <a href="?action=trainerMaster"> <i class="fa fa-folder-open"></i>Submited Article</a> </li>
