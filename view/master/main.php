				...
				<div class="container">
					<div class="col-md-9 col-sm-12">
						...
						<?php
							...
							$sql="SELECT * FROM `services` order by sId asc";
							$result=query($sql);
							$i=1;
							$list='';
							...
							<div class="brows-job-list">
								<div class="col-md-12 col-sm-12">
											...
											<div class="advance-search-caption">
												<a href="#" title="Job Dtail"><h4>'.$resultRow['sName'].'</h4></a>
												
												
												
												<p><span><b>Author(s):</b></span>'.$resultRow['Author'].'</p>
												<p><span><b>DOI: </b></span> <a href="#">'.$resultRow['DOI'].'</a></p>
												<p><span><b>Cite: </b></span>'.$resultRow['cite'].'</p>
												<a href="'.BASEURL.'Abstractview/'.$resultRow['sId'].'"  class="btn advance-search" title="apply">Read More <i class="fa fa-arrow-right"></i></a>
											</div>
